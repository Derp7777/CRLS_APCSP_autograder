...
class testAutograde(unittest.TestCase):
    def test_1(self):
        ...
        for i in range(1000):
            if game(percent):
                wins += 1
        self.assertTrue(710 < wins < 790, "<br>Ran 1000 sims, should get between 710 and 790 wins.  "
    ...
    def test_2(self):
        ...
        play_tournament_output = f.getvalue().rstrip().lower()
    ...
    def test_4(self):
        ...
        with redirect_stdout(f):
            for i in range(10000):
                sim_data = play_season(sim_data, 0.60)
        self.assertTrue(sim_data[2] < sim_data[0] and sim_data[2] < sim_data[1],
                        "<br>Ran 1000 sims with win pecentage of 50%.  Serena should win US open the most,"
    ...
    def test_5(self):
        ...
        data_analysis_output = f.getvalue().rstrip().lower()
        ...
        self.assertTrue(all([found1 > 0, found2 > 0, found3 > 0, found4 > 0]),
                        "<br> Ran data_analysis with p_sim of [25, 50, 75, 3] and 200 simulations.<br>"
    ...
    def test_6(self):
        ...
        run_simulation_output = f.getvalue().rstrip().lower()
        found1 = len(re.findall(r"out\sof\s13\ssimulations", run_simulation_output,  re.X | re.M | re.S))
        self.assertTrue(found1 >= 3,
                        "<br>Ran run_simulation(13, 10000).  Expected to see 'of 13 simulations' 3 times."
                        "<br>" + run_simulation_output +
                        "<br>Matched this many times: " + str(found1))
