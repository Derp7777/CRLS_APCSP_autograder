...
class testAutograde(unittest.TestCase):
    def test_1(self):
        ...
        if getattr(stack1, 'singles') == 1 and getattr(stack1, 'fives') == 2 and \
            ...
            success = True
        self.assertEqual(True, success, "Verifying that the __init__ method is correct")
    ...
    def test_2(self):
        ...
        success = False
        if stack3.singles == 3 and stack3.fives == 1 and stack3.tens == 1 and stack3.twenties == 3 and \
                stack3.hundreds == 8:
            success = True
        self.assertEqual(True, success, "Verifying that moneystack of (1, 1, 1, 2, 3) <br>"
    ...
    def test_3(self):
        ...
        stack3 = stack1 + stack2
        success = False
        if stack3.singles == 3 and stack3.fives == 1 and stack3.tens == 1 and stack3.twenties == 4 and \
                stack3.hundreds == 13:
            success = True
        self.assertEqual(True, success, "Verifying that moneystack of (4, 1, 1, 2, 3) <br>"
